...
func FetchUpstreamRatios(c *gin.Context) {
	...
	for _, chn := range upstreams {
		...
		go func(chItem dto.UpstreamDTO) {
			...
			var pricingItems []upstreamPricingItem
			...
			converted, warnings := upstreamPricingItemsToSyncData(pricingItems)
			ch <- upstreamResult{Name: uniqueName, Data: converted, Warnings: warnings}
		}(chn)
	}
