...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM payment_metadata")
		...
		DB.Exec("DELETE FROM pricing_sync_sources")
		DB.Exec("DELETE FROM pricing_sync_quotes")
		DB.Exec("DELETE FROM pricing_sync_model_states")
	})
}
