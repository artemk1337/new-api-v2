...
func TestChannelTagsRouteUsesReadPermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "/tags", authz.ChannelRead, controller.GetAllChannelTags)
}
